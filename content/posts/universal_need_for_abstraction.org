...
Recently I discovered about Apple's [[https://pkl-lang.org][Pkl language]] for generating static configuration files such as JSON and YAML. I found the idea ludicrous:
...
Why sandwich a weak language in the middle there?
...
is a workaround rather than a proper solution, which leads to technical debt.
...
or programs that can't be refactored and yet are widely-used.
